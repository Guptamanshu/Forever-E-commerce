  ...
  return (
    <div className='my-10'>
        <div className='text-center py-8 text-3x1'>
            ...
            Discover fashion that blends comfort, confidence, and modern style, helping you express your personality effortlessly with every outfit you choose to wear every single day.
            </p>
        </div>
        {/* Rendering Products */}
